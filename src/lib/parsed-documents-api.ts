/**
 * Client utility for interacting with the Parsed Documents CRUD API
 */
...
class ParsedDocumentsAPI {
  private baseUrl: string;

  constructor(baseUrl: string = '/api/parsed-documents') {
...
export const parsedDocumentsAPI = new ParsedDocumentsAPI();
