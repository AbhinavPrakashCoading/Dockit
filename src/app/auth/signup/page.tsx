...
import { AlertCircle, Loader2, Chrome, Mail, Lock, User } from 'lucide-react'
...
export default function SignUpPage({ 
  ...
  useEffect(() => {
    // Check if user is already authenticated (only if not skipping redirect check)
        ...
        {showHeader && (
          <CardHeader className="space-y-1 text-center p-0 mb-6">
            ...
            <CardDescription className="text-slate-600">
              Get started with Dockit's document intelligence platform
            </CardDescription>
          </CardHeader>
        )}
