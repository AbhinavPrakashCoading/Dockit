...
const UploadModal: React.FC<UploadModalProps> = ({ 
  ...
  // Debug logging
  console.log('🎯 UploadModal rendering with exam:', selectedExam?.name);
  ...
  const getDocumentTypeMapping = () => {
    console.log('🔍 Getting document type mapping for exam:', selectedExam?.name);
    console.log('📊 Exam schema exists:', !!selectedExam?.schema);
    console.log('� Separate schema exists:', !!selectedExamSchema);
    ...
    return schema?.documents?.reduce((acc: any, doc: any) => {
      ...
      console.log(`📋 Mapped ${doc.type}: required=${isRequired}`);
      return acc;
    }, {}) || {};
  };
